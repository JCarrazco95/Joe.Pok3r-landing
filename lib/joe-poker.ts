...
export const reels: Reel[] = [
  {
    ...
    poster: '/reels/poster-9.webp',
    titulo: 'La sala llena · Day 1A',
    seg: 34,
    vertical: true,
  },
  {
...
export const galeria: Foto[] = [
  {
    src: '/quinto-lugar-296k.webp',
    alt: 'Conteo de fichas del Mini Main Event con Joe Vega quinto del field con 296,000',
    pie: '5.º del field · 296K (74 BB)',
    ancho: 773,
    alto: 1178,
    evento: 'wsop-circuit',
  },
  ...
  {
    src: '/wsop-live-mesa-34.webp',
    alt: 'App WSOP Live: mesa 34, asiento 6, con Joe Vega liderando la mesa con 296,000',
    pie: 'Mesa 34 · líder con 296K',
    ancho: 929,
    alto: 1280,
    evento: 'wsop-circuit',
  },
  {
    src: '/cash-game.webp',
    alt: 'Joe.Pok3r en una mesa de cash game con su stack de fichas',
    pie: 'Cash game',
    ancho: 589,
    alto: 1280,
    evento: 'wsop-vegas',
  ...
  {
    src: '/con-negreanu.webp',
    alt: 'Joe.Pok3r junto a Daniel Negreanu en la sala de torneo de la WSOP en Las Vegas',
    pie: 'Con Daniel Negreanu',
    ancho: 1050,
    alto: 1400,
    evento: 'wsop-vegas',
  },
  {
    src: '/letras-wsop.webp',
    alt: 'Joe.Pok3r frente a las letras gigantes de WSOP',
    pie: 'Las letras',
    ancho: 960,
    alto: 1280,
    evento: 'wsop-vegas',
  ...
  {
    src: '/entrada-wsop-2023.webp',
    alt: 'Joe.Pok3r en la entrada de la World Series of Poker 2023',
    pie: 'La entrada, WSOP 2023',
    ancho: 918,
    alto: 1280,
    evento: 'wsop-vegas',
  },
  {
    src: '/reloj-mini-main.webp',
    alt: 'Reloj del torneo: Mini Main Event Day 1A, bolsa de MX$1,814,400 y 48 jugadores de 184',
    pie: '48 de 184 · bolsa MX$1,814,400',
    ancho: 960,
    alto: 1280,
    evento: 'wsop-circuit',
  },
  ...
  {
    src: '/paris-las-vegas.webp',
    alt: 'Joe.Pok3r en una mesa del Paris Las Vegas con sudadera de la WSOP y su stack de fichas',
    pie: 'Paris Las Vegas',
    ancho: 1050,
    alto: 1400,
    evento: 'wsop-vegas',
  ...
  {
    src: '/bajo-los-banners.webp',
    alt: 'Joe.Pok3r en su mesa bajo los estandartes de campeones de Chris Ferguson y Shaun Deeb',
    pie: 'Bajo los estandartes de campeones',
    ancho: 1050,
    alto: 1400,
    evento: 'wsop-vegas',
  },
  {
    src: '/buy-in-main-event.webp',
    alt: 'Recibos del buy-in del Main Event de la WSOP 2023: evento 76, diez mil dólares, mesa 629 asiento 7',
    pie: 'Main Event 2023 · $10,000 de buy-in',
    ancho: 960,
    alto: 1280,
    evento: 'wsop-vegas',
  },
  ...
  {
    src: '/mesa-wsop-vegas.webp',
    alt: 'Joe.Pok3r concentrado en la mesa durante un evento de la WSOP en Las Vegas',
    pie: 'En juego · WSOP Las Vegas',
    ancho: 1050,
    alto: 1400,
    evento: 'wsop-vegas',
  },
  {
    src: '/stack-25k.webp',
    alt: 'Torres de fichas WSOP de Big Bola, con las de 25,000 encima',
    pie: 'El stack, con las de 25K',
    ancho: 960,
    alto: 1280,
    evento: 'wsop-circuit',
  },
